    ...
    appwriteConfig.databases
      ...
      .then(() => {
        callAPI(
          ...
          `Hey ${name}, You have been aceepted to attend the ${
            event && event.eventname
          }. We hope you have a great time. Contact the host at ${
      ...
      .then(() => {
        callAPI(
          ...
          `Hey ${name}, we regret to inform you that your invitation has been cancelled to attend ${
            event && event.eventname
          }. We hope you look for other events in future. Contact the host at ${
            JSON.parse(localStorage.getItem("userInfo") || "{}").email
          } for any further queries`
        );
      });
